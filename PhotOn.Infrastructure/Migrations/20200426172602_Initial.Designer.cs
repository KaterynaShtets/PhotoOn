...
namespace PhotOn.Infrastructure.Migrations
{
    ...
    [Migration("20200426172602_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotOn.Core.Entities.Award", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PhotOn.Core.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("PhotOn.Core.Entities.Event", b =>
                {
                    b.HasOne("PhotOn.Core.Entities.Award", "Award")
                        .WithMany()
            ...
            modelBuilder.Entity("PhotOn.Core.Entities.Like", b =>
                {
                    ...
                    b.HasOne("PhotOn.Core.Entities.User", "User")
                        .WithMany("Likes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
